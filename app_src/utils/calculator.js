// https://raw.githubusercontent.com/hectorares/curp-rfc/master/calculaRfcCurp.html

module.exports.calcular = (nombre, ap_paterno, ap_materno, dteNacimiento, sexo, estado,) => {
    ...
    const curp = fnCalculaCURP(nombre_f.toUpperCase(), ap_pat_f.toUpperCase(), ap_mat_f.toUpperCase(), dteNacimiento, sexo, estado);
